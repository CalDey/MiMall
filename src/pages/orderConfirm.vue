...
export default {
    ...
    data() {
        return {
            ...
            showDelModal: false,    // 是否显示弹框
            showEditModal: false,   // 是否显示新增地址弹框
            checkIndex: 0   // 当前选中的收货地址索引
        }
    },
    components: {
        Modal
    ...
    methods: {
        ...
        getCartList() {
            this.axios.get('/carts').then((res) => {
                ...
                this.cartList = list.filter(item => item.productSelected);  // 选中商品列表
                // 遍历所有选中商品数量获取商品总数
